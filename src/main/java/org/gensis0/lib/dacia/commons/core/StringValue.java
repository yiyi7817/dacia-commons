...
import static org.gensis0.lib.dacia.commons.utils.Preconditions.checkNotNull;
 ...
 * encapsulates the basic functionality of a {@link String}, in a serializable
 * and mutable way.
 * <p>
 * The mutability allows to reuse the object inside the user code, also across
 * invocations. Reusing a StringValue object helps to increase the performance,
 * as string objects are rather heavy-weight objects and incur a lot of garbage
...
public class StringValue implements NormalizableKey<StringValue>, CharSequence, ResettableValue<StringValue>,
	...
	private char[] value; // character value of the string value, not
	...
	/**
	 * Returns this StringValue's internal character data. The array might be
	 * larger than the string which is currently stored in the StringValue.
	 * 
	 ...
	 *            The new string value.
	 * @param offset
	 *            The position to start the substring.
	 * @param len
	 *            The length of the substring.
	 */
	...
	/**
	 * Sets the contents of this string to the contents of the given
	 * <tt>CharBuffer</tt>. The characters between the buffer's current position
	 * (inclusive) and the buffer's limit (exclusive) will be stored in this
	 * string.
	 * 
	 * @param buffer
	 ...
	 * 
	 * @param chars
	 *            The new string value (as a character array).
	 * @param offset
	 *            The position to start the substring.
	 * @param len
	 *            The length of the substring.
	...
	/**
	 * Sets the value of this <code>StringValue</code>, assuming that the binary
	 * data is ASCII coded. The n-th character of the <code>StringValue</code>
	 * corresponds directly to the n-th byte in the given array after the
	 * offset.
	 * 
	 * @param bytes
	...
	/**
	 * Returns a new <tt>StringValue</tt>string that is a substring of this
	 * string. The substring begins at the given <code>start</code> index and
	 * ends at end of the string
	 *
	 * @param start
	 ...
	 * substring begins at the given <code>start</code> index and ends at end of
	 * the string
	 *
	 * @param target
	 *            The StringValue object to copy the substring to.
	 * @param start
	 *            The beginning index, inclusive.
	 * @exception IndexOutOfBoundsException
	 *                Thrown, if the start is negative.
	...
	/**
	 * Copies a substring of this string into the given target StringValue. The
	 * substring begins at the given <code>start</code> index and ends at
	 * <code>end - 1</code>.
	 * 
	 * @param target
	 *            The StringValue object to copy the substring to.
	...
	/**
	 * Finds any occurrence of the <code>str</code> character sequence in this
	 * StringValue.
	 * 
	 * @return The position of the first occurrence of the search string in the
	 *         string value, or <code>-1</code>, if the character sequence was
	 *         not found.
	 */
	...
	/**
	 * Finds any occurrence of the <code>str</code> character sequence in this
	 * StringValue. The search starts at position <code>start</code>.
	 * 
	 * @return The position of the first occurrence of the search string in the
	 *         string value, or <code>-1</code>, if the character sequence was
	 *         not found.
	...
	/**
	 * Checks whether the substring, starting at the specified index, starts
	 * with the given prefix string.
	 * 
	 * @param prefix
	 *            The prefix character sequence.
	 * @param startIndex
	 *            The position to start checking for the prefix.
	 * 
	 * @return True, if this StringValue substring, starting at position
	 *         <code>startIndex</code> has <code>prefix</code> as its prefix.
	 */
	...
	public static String readString(DataInput in) throws IOException {
		// the length we read is offset by one, because a length of zero
	...
	public static final void writeString(CharSequence cs, DataOutput out) throws IOException {
		if (cs != null) {
			// the length we write is offset by one, because a length of zero
			// indicates a null value
	...
	public static final void copyString(DataInput in, DataOutput out) throws IOException {
		...
		// note that the length is one larger than the actual length (length 0
		// is a null string, not a zero length string)
		len--;
