...
import org.gensis0.lib.dacia.commons.exception.DACIAThrowable;
...
public final class ExceptionUtils {
	 ...
	 * suppressed exception} to a prior exception, or returns the new exception,
	 * if no prior exception exists.
	 *
	 * <pre>
	 * {@code
	 *
	 ...
	 *
	 * @param newException
	 *            The newly occurred exception
	 * @param previous
	 *            The previously occurred exception, possibly null.
	 *
	 * @return The new exception, if no previous exception exists, or the
	 *         previous exception with the new exception in the list of
	 *         suppressed exceptions.
	 */
	public static <T extends DACIAThrowable> T firstOrSuppressed(T newException, @Nullable T previous) {
	...
	/**
	 * Throws the given {@code Throwable} in scenarios where the signatures do
	 * not allow you to throw an arbitrary Throwable. Errors and
	 * RuntimeExceptions are thrown directly, other exceptions are packed into
	 * runtime exceptions
	 * 
	 * @param t
	 ...
	 * Throws the given {@code Throwable} in scenarios where the signatures do
	 * not allow you to throw an arbitrary Throwable. Errors and
	 * RuntimeExceptions are thrown directly, other exceptions are packed into a
	...
	/**
	 * Throws the given {@code Throwable} in scenarios where the signatures do
	 * allow to throw a Exception. Errors and Exceptions are thrown directly,
	 * other "exotic" subclasses of Throwable are wrapped in an Exception.
	 *
	 * @param t
	 *            The throwable to be thrown.
	 * @param parentMessage
	 *            The message for the parent Exception, if one is needed.
	 */
	 ...
	 * signatures allows only IOExceptions (and RuntimeException and Error).
	 * Throws this exception directly, if it is an IOException, a
	 * RuntimeException, or an Error. Otherwise does nothing.
	 *
	 * @param t
	 *            The Throwable to be thrown.
	 */
	 ...
	 * allows only IOExceptions (and RuntimeException and Error).
	 * 
	 * Throws this exception directly, if it is an IOException, a
	 * RuntimeException, or an Error. Otherwise it wraps it in an IOException
	 * and throws it.
	 * 
	 * @param t
	 *            The Throwable to be thrown.
