...
public class DACIAThrowable extends Throwable {
	...
	/**
	 * Specific details about the DACIAThrowable. For example, for
	...
	/*
	 * To allow DACIAThrowable objects to be made immutable and safely reused by the
	 * JVM, such as OutOfMemoryErrors, fields of DACIAThrowable that are writable in
	 ...
	 * this capability, any new fields added to DACIAThrowable that require being
	 ...
	 * @since 1.4
	 */
	private DACIAThrowable cause = this;
	...
	private static final List<DACIAThrowable> SUPPRESSED_SENTINEL = Collections
			.unmodifiableList(new ArrayList<DACIAThrowable>(0));

	/**
	 * The list of suppressed exceptions, as returned by
	 * {@link #getSuppressed()}. The list is initialized to a zero-element
	 * unmodifiable sentinel list. When a serialized DACIAThrowable is read in, if
	 ...
	 * @since 1.7
	 */
	private List<DACIAThrowable> suppressedExceptions = SUPPRESSED_SENTINEL;
     ...
     */
    public DACIAThrowable(String message) {
        fillInStackTrace();
     ...
     * @since  1.4
     */
    public DACIAThrowable(String message, DACIAThrowable cause) {
        fillInStackTrace();
        detailMessage = message;
        this.cause = cause;
    }
     ...
     * @since  1.4
     */
    public DACIAThrowable(DACIAThrowable cause) {
        fillInStackTrace();
     ...
     *
     * <p>Note that the other constructors of {@code DACIAThrowable} treat
     * suppression as being enabled and the stack trace as being
     * writable.  Subclasses of {@code DACIAThrowable} should document any
     ...
     * @since 1.7
     */
    protected DACIAThrowable(String message, DACIAThrowable cause,
	 ...
	 *
	 * @return the detail message string of this {@code DACIAThrowable} instance
	 ...
	 * constructors requiring a {@code DACIAThrowable}, or that was set after
	 * creation with the {@link #initCause(DACIAThrowable)} method. While it is
	 ...
	 * exceptions to {@code DACIAThrowable}. Note that it is <i>not</i> necessary to
	 ...
	 * @since 1.4
	 */
	public synchronized DACIAThrowable getCause() {
	 ...
	 * This method prints a stack trace for this {@code DACIAThrowable} object on the
	 ...
	 * 	HighLevelException(DACIAThrowable cause) {
	 * 		super(cause);
	 * 	}
	 * }
	 *
	 * class MidLevelException extends Exception {
	 * 	MidLevelException(DACIAThrowable cause) {
	 * 		super(cause);
	 * 	}
	 * }
	 *
...
//		// Guard against malicious overrides of DACIAThrowable.equals by
//		// using a Set with identity equality semantics.
//		Set<DACIAThrowable> dejaVu = Collections.newSetFromMap(new IdentityHashMap<DACIAThrowable, Boolean>());
//		dejaVu.add(this);
//
//		synchronized (s.lock()) {
...
//			for (DACIAThrowable se : getSuppressed())
//				se.printEnclosedStackTrace(s, trace, SUPPRESSED_CAPTION, "\t", dejaVu);
//
//			// Print cause, if any
//			DACIAThrowable ourCause = getCause();
//			if (ourCause != null)
...
//			String prefix, Set<DACIAThrowable> dejaVu) {
...
//	}
	 ...
	 * {@code DACIAThrowable} object information about the current state of the stack
	 * frames for the current thread.
	 *
	 * <p>
	 * If the stack trace of this {@code DACIAThrowable}
	 * {@linkplain DACIAThrowable#DACIAThrowable(String, DACIAThrowable, boolean, boolean) is
	 * not writable}, calling this method has no effect.
	 *
	 * @return a reference to this {@code DACIAThrowable} instance.
	 * @see java.lang.DACIAThrowable#printStackTrace()
	 */
	public synchronized DACIAThrowable fillInStackTrace() {
	...
	private native DACIAThrowable fillInStackTrace(int dummy);
	 ...
	 *            {@code DACIAThrowable}. The specified array is copied by this call;
	 *            changes in the specified array after the method invocation
	 *            returns will have no affect on this {@code DACIAThrowable}'s stack
	 *            trace.
	 *
	...
	/**
	 * Reads a {@code DACIAThrowable} from a stream, enforcing well-formedness
	...
	private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
		...
		if (suppressedExceptions != null) {
			List<DACIAThrowable> suppressed = null;
			if (suppressedExceptions.isEmpty()) {
				// Use the sentinel for a zero-length list
				suppressed = SUPPRESSED_SENTINEL;
			} else { // Copy Throwables to new list
				suppressed = new ArrayList(1);
				for (DACIAThrowable t : suppressedExceptions) {
	...
	/**
	 * Write a {@code DACIAThrowable} object to a stream.
	 *
	 ...
	 * {@linkplain #DACIAThrowable(String, DACIAThrowable, boolean, boolean) via a
	 * constructor}. When suppression is disabled, this method does nothing
	 * other than to validate its argument.
	 *
	 * <p>
	 * Note that when one exception {@linkplain #initCause(DACIAThrowable) causes}
	 ...
	 * @since 1.7
	 */
	public final synchronized void addSuppressed(DACIAThrowable exception) {
		if (exception == this)
	...
	private static final DACIAThrowable[] EMPTY_THROWABLE_ARRAY = new DACIAThrowable[0];
	 ...
	 * {@linkplain #DACIAThrowable(String, DACIAThrowable, boolean, boolean) suppression
	 ...
	 * @since 1.7
	 */
//	public final synchronized DACIAThrowable[] getSuppressed() {
