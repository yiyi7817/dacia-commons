...
import org.gensis0.lib.dacia.commons.exception.NullFieldException;

/**
 * The base class of all tuples. Tuples have a fix length and contain a set of
 * fields, which may all be of different types. Because Tuples are strongly
 * typed, each distinct tuple length is represented by its own class. Tuples
 * exists with up to 25 fields and are described in the classes {@link Tuple1}
 * to {@link Tuple25}.
 * <p>
 * The fields in the tuples may be accessed directly a public fields, or via
 * position (zero indexed) {@link #getField(int)}.
 * <p>
 * Tuples are in principle serializable. However, they may contain
 * non-serializable fields, in which case serialization will fail.
 */
public abstract class Tuple implements java.io.Serializable {
	 ...
	 *
	 * @param pos
	 *            The position of the field, zero indexed.
	 ...
	 * the field is null. Used for comparing key fields.
	 * 
	 * @param pos
	 *            The position of the field, zero indexed.
	 * @return The field at the specified position.
	 ...
	 *
	 * @param value
	 *            The value to be assigned to the field at the specified
	 *            position.
	 * @param pos
	 *            The position of the field, zero indexed.
	 * @throws IndexOutOfBoundsException
	 ...
	 * (dimensions). For example, {@code getTupleClass(3)} will return the
	 * {@code Tuple3.class}.
	 * 
	 * @param arity
	...
	private static final Class<?>[] CLASSES = new Class<?>[] { Tuple0.class, Tuple1.class, Tuple2.class, Tuple3.class,
			Tuple4.class, Tuple5.class, Tuple6.class, Tuple7.class, Tuple8.class, Tuple9.class, Tuple10.class,
			Tuple11.class, Tuple12.class, Tuple13.class };
